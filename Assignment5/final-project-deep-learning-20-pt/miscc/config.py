...
__C.TEST.ORIG_TEST_IMAGES = ''
__C.TEST.MID_TEST_IMAGES = ''

# Training options
__C.TRAIN = edict()
__C.TRAIN.PRE_EPOCH = 0
__C.TRAIN.MAX_EPOCH = 0
__C.TRAIN.GEN_EPOCH = 0
...
__C.TRAIN.FAKE_WEIGHT = 0.0
__C.TRAIN.PRE_FLAG = False
__C.TRAIN.PRE_MARGIN = 0.0
__C.TRAIN.SOFT_LABEL = 0.0
__C.TRAIN.GAMMA = 0.0
__C.TRAIN.LAMBDA_K = 0.0
